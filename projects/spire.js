...
spire.name = "Spire";
spire.description =
  "Spire is a rasterization-based voxel renderer written in Vulkan which can render 1.8 billion+ voxels in full detail in real time developed for my Honours project. " +
